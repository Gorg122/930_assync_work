...
def FPGA_flash(User_path):
    ...
    Quartus_pgm_path = "C:/intelFPGA_lite/21.1/quartus/bin64/quartus_pgm.exe"
    Quartus_jtag_path = "C:/intelFPGA_lite/21.1/quartus/bin64/jtagconfig.exe"
    Quartus_sh_path = "C:/intelFPGA_lite/21.1/quartus/bin64/quartus_sh.exe"
