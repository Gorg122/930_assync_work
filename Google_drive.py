...
def File_upload(service, folder_id, file_path):
    ...
    name = 'rezult.zip'
    #file_path = 'C:/intelFPGA_lite/Google_Drive/Test_upload/result.zip'
    file_metadata = {
        'name': name,
...
# Folder_id = Folder_create(Users_drive="grisha.petuxov", main_folder_id=main_folder_id)
# file_link = File_upload(folder_id=Folder_id)